      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            {/* Trust Rating */}
            <div className="flex items-center gap-3 bg-card/50 backdrop-blur-sm border border-border/50 rounded-full px-4 py-2 w-fit">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-muted-foreground text-sm">from 50+ students</span>
              </div>
            </div>
